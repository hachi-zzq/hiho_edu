...
<div class="page-header">
    <h1><span class="text-light-gray">运营 / </span>新增广告</h1>
</div> <!-- / .page-header -->
<div class="panel">
    @if (\Session::get('tips'))
        ...
        <form class="panel form-horizontal"  enctype="multipart/form-data"  method="POST">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly="readonly" class="form-control" id="inputEmail"  value="{{$objPosition->readable_type}}" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail" name="ad_name" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputNickname" name="ad_description">
                    </div>

                </div>
                @if($objPosition->type == 'picture' || $objPosition->type== 'rotation')
                <script>
                    init.push(function () {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputNickname" name="ad_href">
                    </div>

                </div>
                @endif

                @if($objPosition->type == 'text')
                <div class="form-group">
                    <label for="inputPortrait" class="col-sm-2 control-label">广告文字</label>

                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputNickname" name="ad_text">
                    </div>
                </div>
                ...
                @if($objPosition->type == 'code')
                <div class="form-group">
                    <label for="inputNickname" class="col-sm-2 control-label">代码广告</label>

                    <div class="col-sm-10">
                        <textarea style="width: 1330px;height: 100px;" name="ad_code"></textarea>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="status" id="optionsIsAdmin1" value="0" class="px"">
                                <span class="lbl">否</span>
                            </label>
                        </div>
                    </div>
                </div>
                <input type="hidden" name="id" value="{{$objPosition->id}}">
                <input type="hidden" name="type" value="{{$objPosition->type}}">
                <!-- / .form-group -->
