        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="5"><button class="btn btn-sm" disabled>当前顶级</button> <a href="{{route('adminCategories')}}"><button class="btn btn-sm" disabled>返回顶级...</button></a> <a href="{{route('adminCategories')}}"><button class="btn btn-sm">返回上级...</button></a></td>
                    </tr>
