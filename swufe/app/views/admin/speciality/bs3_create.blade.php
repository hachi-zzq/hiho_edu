...
<div class="page-header">
    <h1><span class="text-light-gray">教师与机构 / </span>创建新专业</h1>
</div> <!-- / .page-header -->
<div class="panel">
    @if (\Session::get('tips'))
...
<div class="row">
    <div class="col-sm-12">
        <form class="panel form-horizontal" method="POST" action="{{route('adminSpecialityAddPost')}}">
            <div class="panel-heading">
                <span class="panel-title">新专业</span>
            </div>
