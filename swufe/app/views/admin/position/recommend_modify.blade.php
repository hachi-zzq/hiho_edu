...
<div class="page-header">
    <h1><span class="text-light-gray">运营 / </span>推荐位修改</h1>
</div> <!-- / .page-header -->
<div class="panel">
    @if (\Session::get('tips'))
        ...
        <form class="panel form-horizontal"   method="POST">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputNickname" name="class" value="{{$objPosition->class}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword"  name="max_number" value="{{$objPosition->max_num}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="type">
                            <option value="video" @if($objPosition->type == 'video') selected @endif>视频</option>
                            <option value="teacher" @if($objPosition->type == 'teacher') selected @endif>讲师</option>
                        </select>
                    </div>
                </div>
