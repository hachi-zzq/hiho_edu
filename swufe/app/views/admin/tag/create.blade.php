...
<div class="page-header">
    <h1><span class="text-light-gray">分类与主题 / </span>创建标签</h1>
</div> <!-- / .page-header -->
<div class="panel">
    @if (\Session::get('tips'))
...
<div class="row">
    <div class="col-sm-12">
        <form class="panel form-horizontal" method="POST" action="{{route('adminTagAdd')}}">
            <div class="panel-heading">
                <span class="panel-title">新标签</span>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputName" placeholder="名称" name="tag_name"
