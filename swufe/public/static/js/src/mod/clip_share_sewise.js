...
(function ($, win) {
    ...
    _proto.initShareDom = function () {
        ...
        _clip.ctlObj.find('.subtitle-cont').addClass('subtitle-edit'); // clip-subtitle-mode
        ...
        var shareActionHtml = [
            ...
            '<a id="addnoteBtn" href="javascript:void(0)" onclick="addShow()" class="btn-line"><i class="icon-note" ></i><span>添加到笔记</span></a>',
            '</div>',
            '<div class="share-w">',
//            '<ul class="share-list">',
...
//            '</ul>',
        ...
        _clip.shareActionElem.on('mouseenter', '.jiathis_style_32x32 .jiathis_txt', function (e) {
            jiathis_config.url = JLib.config.hostname + '/fragment/' + JLib.config.fragment_guid;
            JLib.tools.setShareSummary(e, config.cfg.share.title, config.cfg.share.from);
        });
    ...
    _proto.destroy = function () {
        ...
        _clip.ctlObj.find('.subtitle-cont').removeClass('clip-subtitle-mode');
